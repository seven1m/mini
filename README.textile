...
# Download and stick the contents of pkg/ in your app's javascript directory (the files in src/ contain comments and whitespace, whereas pkg/ contains minified versions).
# Depending on your needs, add one or more @<script>@ tags, e.g. @<script type="text/javascript" src="/js/ajax.js"></script>@
